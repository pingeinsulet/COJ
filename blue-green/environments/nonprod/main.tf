# Jenkins on ECS - NonProd environment
# Run terraform from this directory: terraform init && terraform plan -var-file=nonprod.tfvars
...
module "jenkins" {
  ...
  expected_aws_account_id   = var.aws_account_id
